...
alang Lang[NO_LANG] =
{
  ...
  {L_DUTCH, "nl", "dutch"},
  {L_FRENCH, "fr", "fran�ais"},
  {L_SPANISH, "es", "espa�ol"},
  {L_GERMAN, "de", "deutsch"}
};
...
/* RPL_NOTCHANOP */
  {"I am not channel operator",	/* english */
    ...
    "Je ne suis pas op�rateur de canal",	/* french */
...
/* RPL_OPONLY */
  {"This channel is in OpOnly Mode",	/* english */
    ...
    "Ese canal est� en modo OpOnly",	/* spanish */
...
/* RPL_ALREADYONCHANNEL */
  {"This user is already on channel",	/* english */
    ...
    "Cet usager est d�j� sur le canal",		/* french */
    "Ese usuario ya est� en el canal",	/* spanish */
...
/* RPL_ALWAYSOPWASACTIVE */
  {"AlwaysOp was active! It's now deactivated",		/* english */
    ...
    "AlwaysOp �tait actif! Il est maintenant d�sactiv�",	/* french */
...
/* RPL_ALWAYSOP */
  {"This channel is in AlwaysOp mode!",		/* english */
    ...
    "Este canal est� en modo AlwaysOp!",	/* spanish */
...
/* RPL_KICK2ND */
  {"Please STOP kicking me!",	/* english */
    ...
    "Veuillez arr�ter de me kicker!",	/* french */
...
/* RPL_BADFLOODLIMIT */
  {"value of FLOODPRO must be in the range [3-20] or 0 to turn it off",
    ...
    "la valeur de FLOODPRO doit �tre entre 3 et 20 ou 0 pour le d�sactiver",
    "El valor de FLOODPRO tiene que estar entre 3 y 20 � 0 para desactivarlo",
...
/* RPL_SETFLOODLIMIT */
  {"value of FLOODPRO is now %d",	/* english */
    ...
    "El valor de FLOOPRO est� ahora %d",	/* spanish */
...
/* RPL_BADNICKFLOODLIMIT */
  {"value of NICKFLOODPRO must be in the range [3-10] or 0 to turn it off",
    ...
    "la valeur de NICKFLOODPRO doit �tre entre 3 et 10 ou 0 pour le d�sactiver",
    "El valor de NICKFLOOPRO tiene que estar entre 3 y 10 � 0 para desactivarlo",
...
/* RPL_SETNICKFLOODLIMIT */
  {"value of NICKFLOODPRO is now %d",	/* english */
    ...
    "El valor de NICKFLOOPRO est� ahora en %d",		/* spanish */
...
/* RPL_BADMASSDEOPLIMIT */
  {"value of MASSDEOPPRO must be in the range [3-10] or 0 to turn it off",
    ...
    "la valeur de MASSDEOPPRO doit �tre entre 3 et 10 ou 0 pour le d�sactiver",
    "El valor de MASSDEOPPRO tiene que estar entre 3 y 10 � 0 para desactivarlo",
...
/* RPL_SETMASSDEOPLIMIT */
  {"value of MASSDEOPPRO is now %d",	/* english */
    ...
    "El valor de MASSDEOPPRO est� ahora en %d",		/* spanish */
...
/* RPL_NOOPON */
  {"value of NOOP is now ON",	/* english */
    ...
    "El valor de NOOP est� ahora en ON",	/* spanish */
...
/* RPL_NOOPOFF */
  {"value of NOOP is now OFF",	/* english */
    ...
    "El valor de NOOP est� ahora en OFF",	/* spanish */
...
/* RPL_BADNOOP */
  {"value of NOOP must be ON or OFF",	/* english */
    ...
    "la valeur de NOOP doit �tre ON ou OFF",	/* french */
...
/* RPL_BADALWAYSOP */
  {"value of ALWAYSOP must be ON or OFF",	/* english */
    ...
    "la valeur de ALWAYSOP doit �tre ON ou OFF",	/* french */
...
/* RPL_BADOPONLY */
  {"value of OPONLY must be ON or OFF",		/* english */
    ...
    "la valeur de OPONLY doit �tre ON ou OFF",	/* french */
...
/* RPL_BADAUTOTOPIC */
  {"value of AUTOTOPIC must be ON or OFF",	/* english */
    ...
    "la valeur de AUTOTOPIC doit �tre ON ou OFF",	/* french */
...
/* RPL_BADUSERFLAGS */
  {"New value can be 1-AUTOOP or 0-NO AUTOOP",
    ...
    "La nouvelle valeur peut �tre 1-AUTOOP ou 0-PAS DE AUTOOP",
...
/* RPL_STATUS1 */
  {"Channel %s has %d user%s (%d operator%s)",	/* english */
    ...
    "Canal %s a %d usager%s (%d op�rateur%s)",	/* french */
...
/* RPL_STATUS5 */
  {"Channel has been idle for %d second%s",	/* english */
    ...
    "El canal no est� activo desde hace %d segundos%s",		/* spanish */
...
/* RPL_SETCHANDEFS */
  {"Channel defaults set.",	/* english */
    ...
    "L'�tat du canal est enregistr�",	/* french */
...
/* RPL_NOTDEF */
  {"That channel is not in my default channel list",	/* english */
    ...
    "Ese canal no est� en mi lista por defecto",	/* spanish */
...
/* RPL_NOOP */
  {"Sorry. This channel is in NoOp mode!",	/* english */
    ...
    "D�sol�. Ce canal est en mode NoOp!",	/* french */
    "Lo siento, �Ese canal est� en modo NoOp!",		/*  spanish */
...
/* RPL_CANTBEOP */
  {"Sorry. You are not allowed to be chanop",	/* english */
    ...
    "D�sol�. Il ne vous est pas permis d'�tre op�rateur",	/* french */
...
/* RPL_CANTBEOPPED */
  {"This user is not allowed to be chanop",	/* english */
    ...
    "Cet usager n'a pas le droit d'�tre op�rateur",	/* french */
    "Ese usuario no est� autorizado para ser operador en el canal",	/* spanish */
...
/* RPL_USERISPROTECTED */
  {"This user is protected",	/* english */
    ...
    "Cet usager est prot�g�",	/* french */
    "Este usuario est� protegido",	/* spanish */
...
/* RPL_USERNOTONCHANNEL */
  {"User %s is not on channel %s!",	/* english */
    ...
    "El usuario %s no est� presente en el canal %s!",	/* spanish */
...
/* RPL_YOUREDEOPPEDBY */
  {"You're deopped by %s",	/* english */
    ...
    "Vous �tes d�opp� par %s",	/* french */
    "El %s te quit� el status de op%s",		/* spanish */
...
/* RPL_ISSERVICE */
  {"I don't think %s would appreciate that.",	/* english */
    ...
    "Je ne pense pas que %s apprécierait ça.",	/* french */
    "No creo que a %s le guste eso.",		/* spanish */
    "Ich glaube nicht, dass %s das zu schätzen wissen würde."		/* german */
  }
};
